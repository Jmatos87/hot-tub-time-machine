	...
	var AppView = _react2.default.createClass({
		...
		_timeWarp: function _timeWarp() {
			...
			if (!this.state.timeChange) {
				...
				var boundStuff = incrementYear.bind(this);
				num -= 200;
				this.intervalId = setInterval(boundStuff, num);
			}
		},
		_timeDeath: function _timeDeath() {
			...
			if (!this.state.timeChange) {
				...
				var boundStuff = decrementYear.bind(this);
				num -= 200;
				this.intervalId = setInterval(boundStuff, num);
			}
		},

		_timeStop: function _timeStop() {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				"div",
				{ id: "stuff" },
				_react2.default.createElement("img", { src: "http://www.admitonedrinkinggames.com//wp-content/uploads/2014/02/file_203203_0_Hot_Tub_Time_Machine.jpg" }),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"button",
							{ onClick: this._timeWarp },
							"Let's Do the Time Warp"
						),
						_react2.default.createElement(
							"button",
							{ onClick: this._timeDeath },
							"Turn Back the Hands of Time"
						),
						_react2.default.createElement(
							"button",
							{ onClick: this._timeStop },
